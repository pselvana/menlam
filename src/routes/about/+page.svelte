<div class="prose p-6">
	<h1>About</h1>
	<p>
		Bhutan Infectious Disease Guideliness is intended for use by medical professionals in Bhutan 🇧🇹. Information is provided as a
		reference guide and should not replace clinical judgement or national standards of care.
	</p>

	<p>
		It was created by Dr. Vamini Selvanandan to facilitate quick access to treatment guidelines from the <i
			>National Antibiotic Guideline 2018</i
		> published by the Ministry of Health, Bhutan.
	</p>
	<br />

	<details>
		<summary class="cursor-pointer font-semibold text-base">Foreword</summary>
	...
	<details>
		<summary class="cursor-pointer font-semibold text-base">Acknowledgements</summary>
		<div class="mt-2 text-sm leading-relaxed">
			<p>
			...
			<ol>
				<li>Dr. G.P. Dhakal, Gastroenterologist, JDWNRH</li>
				<li>Dr. Kuenley Pedon, Paediatrician, JDWNRH</li>
				<li>Dr. Kunga Penjor, Prosthodontist, JDWNRH</li>
				<li>Dr. Mahesh Gurung, Cardiologist, JDWNRH</li>
				<li>Dr. Pem Chuki, Clinical Pharmacologist, JDWNRH</li>
				<li>Dr. Sonam Jamtsho, Gynaecologist, JDWNRH</li>
				<li>Dr. Tashi Tenzin, Neurosurgeon, JDWNRH</li>
				<li>Dr. Ugyen Tshering, Emergency Physician, JDWNRH</li>
				<li>Dr. Ugyen Thinley, Orthopaedic Surgeon, JDWNRH</li>
				<li>Dr. Yoriko Nishizawa, Neonatologist, KGUMSB</li>
				<li>Mr. Raghunath Sharma, Laboratory Officer, JDWNRH</li>
				<li>Mr. Thupten Tshering, Clinical Pharmacist, JDWNRH</li>
			</ol>
			<p>Secretariat, layout and the cover design:</p>
			<ol>
				<li>Ugyen Tashi, Dy. Chief Pharmacist, EMTD</li>
			</ol>
		</div>
	</details>
